...
class ReplicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddReplica = channel.unary_unary(
                '/chat.ReplicationService/AddReplica',
                request_serializer=chat__pb2.AddReplicaRequest.SerializeToString,
                response_deserializer=chat__pb2.Response.FromString,
                _registered_method=True)
        self.TransferState = channel.unary_unary(
                '/chat.ReplicationService/TransferState',
                request_serializer=chat__pb2.Empty.SerializeToString,
                response_deserializer=chat__pb2.StateSnapshot.FromString,
                _registered_method=True)
...
def add_ReplicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TransferState': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=chat__pb2.StateSnapshot.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ReplicationService(object):
    ...
    def TransferState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            chat__pb2.StateSnapshot.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
